...
int main(int agrc, char *argv[])
{
  ...
  // Open the hist file
  TFile *hists_file_mc = TFile::Open("results/hists_tt_test_"+reco_or_pl+".root");


  // Get histograms
  
  // dR_min - sig/bkg discrimination
  TH1 *h_min_dR_lep0_btags_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_min_dR_lep0_btag_from_top");
  TH1 *h_min_dR_lep1_btags_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_min_dR_lep1_btag_from_top");
  TH1* h_min_dR_lep0_btags_not_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_min_dR_lep0_btag_not_from_top");
  TH1 *h_min_dR_lep1_btags_not_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_min_dR_lep1_btag_not_from_top");
  ...
  TH1 *h_m_btag_el_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_h_m_btag_el_from_top");
  TH1 *h_m_btag_el_not_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_h_m_btag_el_not_from_top");
  TH1 *h_m_btag_mu_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_h_m_btag_mu_from_top");
  TH1 *h_m_btag_mu_not_from_top = (TH1*)hists_file_mc->Get("2b_emu_OS_h_m_btag_mu_not_from_top");
