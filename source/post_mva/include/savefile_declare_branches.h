  ...
  el_pt_out = el_eta_out = el_cl_eta_out = el_phi_out = el_charge_out = el_e_out = el_topoetcone20_out = el_ptvarcone20_out = el_CF_out = el_d0sig_out = el_delta_z0_sintheta_out = el_pt_bare_out = el_eta_bare_out = el_phi_bare_out = el_e_bare_out = 0;
  ...
  mu_pt_out = mu_eta_out = mu_phi_out = mu_charge_out = mu_e_out = mu_topoetcone20_out = mu_ptvarcone30_out = mu_d0sig_out = mu_delta_z0_sintheta_out = mu_pt_bare_out = mu_eta_bare_out = mu_phi_bare_out = mu_e_bare_out = 0;
  ...
  if (obj_name!="particleLevel") {
    ...
    out_tree->Branch("el_pt_bare", &el_pt_bare_out);
    out_tree->Branch("el_eta_bare", &el_eta_bare_out);
    out_tree->Branch("el_phi_bare", &el_phi_bare_out);
    out_tree->Branch("el_e_bare", &el_e_bare_out);
  }
  ...
  if (obj_name!="particleLevel") { 
    ...
    out_tree->Branch("mu_pt_bare", &mu_pt_bare_out);
    out_tree->Branch("mu_eta_bare", &mu_eta_bare_out);
    out_tree->Branch("mu_phi_bare", &mu_phi_bare_out);
    out_tree->Branch("mu_e_bare", &mu_e_bare_out);
  }
